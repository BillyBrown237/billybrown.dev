...
import UnmountStudio from "./unmountStudio";

export default function Footer() {
    return (
        <UnmountStudio>
            <footer className="border-t dark:border-zinc-800 border-zinc-100 mt-44 lg:min-h-62.5 min-h-full relative">
              ...
              href="https://github.com/Evavic44/billybrown.dev"
              target="_blank"
              rel="noreferrer noopener"
            >
              <BiLogoGithub />
              Stars <em className="text-primary-color not-italic">3,329</em>
                        ...
                        <small className="text-zinc-500">
                            Copyright &copy; Billy Brown {new Date().getFullYear()} All rights
                            Reserved
                        </small>
                    </div>
                </div>
